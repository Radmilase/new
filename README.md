...
Участникам предлагается с использованием доступных роботов, реализовать алгоритм управления **TODO**.

В закрытых тестовых сценариях могут быть изменены конфигурация **TODO**.
